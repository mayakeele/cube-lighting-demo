...
function newCube(name, width, faceColor, wireColor = green, wireShader = 0) {
    var thisCube;
...
function newQuad(name, xWidth, zWidth, faceColor, wireColor = green, wireShader = 0) {
    var thisQuad;
...
function newPlane(name, xWidth, zWidth, xDetail, zDetail, faceColor, wireColor = green, wireShader = 0) {
...
function newTerrainGridRand(name, xWidth, zWidth, xDetail, zDetail, height, faceColor, wireColor = green, wireShader = 0) {
    var xVerts = xDetail + 1;
    var zVerts = zDetail + 1;
    var thisTerrainGrid;
...
function newTerrainGridSmooth(name, xWidth, zWidth, xDetail, zDetail, height, interval, faceColor, wireColor = green, wireShader = 0) {
...
function newTerrainGridSin(name, xWidth, zWidth, xDetail, zDetail, height, numWaves, offset, faceColor, wireColor = green, wireShader = 0) {
    var xVerts = xDetail + 1;
    var zVerts = zDetail + 1;
    var thisTerrainGrid;
    thisTerrainGrid = new SoftEngine.Mesh(name, (xVerts) * (zVerts), xDetail * zDetail * 2, faceColor, wireColor, wireShader);
...
function newDiagCube(name, width, faceColor, wireColor, wireShader) {
    var thisDiagCube;
    thisDiagCube = new SoftEngine.Mesh(name, 6, 8, faceColor, wireColor, wireShader);
    meshes.push(thisDiagCube);

    thisDiagCube.Vertices[0] = new BABYLON.Vector3(-1, 1, 1);
    thisDiagCube.Vertices[1] = new BABYLON.Vector3(1, 1, 1);
    thisDiagCube.Vertices[2] = new BABYLON.Vector3(-1, -1, 1);
    thisDiagCube.Vertices[3] = new BABYLON.Vector3(1, -1, 1);
    thisDiagCube.Vertices[4] = new BABYLON.Vector3(-1, 1, -1);
    thisDiagCube.Vertices[5] = new BABYLON.Vector3(1, 1, -1);

    thisDiagCube.Faces[0] = {
        A: 0,
        B: 1,
        C: 2
    };
    thisDiagCube.Faces[1] = {
        A: 1,
        B: 2,
        C: 3
    };
    thisDiagCube.Faces[2] = {
        A: 1,
        B: 3,
        C: 5
    };
    thisDiagCube.Faces[3] = {
        A: 1,
        B: 5,
        C: 4
    };
    thisDiagCube.Faces[4] = {
        A: 0,
        B: 1,
        C: 4
    };
    thisDiagCube.Faces[5] = {
        A: 1,
        B: 4,
        C: 5
    };
    thisDiagCube.Faces[6] = {
        A: 2,
        B: 3,
        C: 5
    };
    thisDiagCube.Faces[7] = {
        A: 2,
        B: 2,
        C: 4
    };
